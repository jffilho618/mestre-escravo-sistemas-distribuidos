...
template <> constexpr inline auto HttpClient::qt_create_metaobjectdata<qt_meta_tag_ZN10HttpClientE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "onProcessTextFinished",
        "onRequestTimeout"
    };

    QtMocHelpers::UintData qt_methods {
        // Signal 'healthCheckCompleted'
        QtMocHelpers::SignalData<void(const ServerStatus &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
        // Signal 'textProcessingCompleted'
        QtMocHelpers::SignalData<void(const ProcessingResult &)>(5, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 6, 7 },
        }}),
        // Signal 'networkError'
        ...
        // Slot 'onHealthCheckFinished'
        QtMocHelpers::SlotData<void()>(10, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onProcessTextFinished'
...
void HttpClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->healthCheckCompleted((*reinterpret_cast< std::add_pointer_t<ServerStatus>>(_a[1]))); break;
        case 1: _t->textProcessingCompleted((*reinterpret_cast< std::add_pointer_t<ProcessingResult>>(_a[1]))); break;
        case 2: _t->networkError((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 3: _t->onHealthCheckFinished(); break;
        case 4: _t->onProcessTextFinished(); break;
        case 5: _t->onRequestTimeout(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (HttpClient::*)(const ServerStatus & )>(_a, &HttpClient::healthCheckCompleted, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (HttpClient::*)(const ProcessingResult & )>(_a, &HttpClient::textProcessingCompleted, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (HttpClient::*)(const QString & )>(_a, &HttpClient::networkError, 2))
            return;
    }
}
...
// SIGNAL 0
void HttpClient::healthCheckCompleted(const ServerStatus & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void HttpClient::textProcessingCompleted(const ProcessingResult & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 1, nullptr, _t1);
}

// SIGNAL 2
void HttpClient::networkError(const QString & _t1)
{
